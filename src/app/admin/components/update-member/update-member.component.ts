...
export class UpdateMemberComponent implements OnInit {
 ...
 // public uploader: FileUploader = new FileUploader({ url: 'https://evening-anchorage-3159.herokuapp.com/api/' });
  ...
  updateMember() {
    ...
    this.member.updateMemberProfil(this.formMember.value, this.memberId, this.user.remenber_token).subscribe(reponse => {
      ...
      if (reponse && reponse.message === 'success') {
        ...
        this.router.navigate(['/admin/profile', this.memberId]);
      }
