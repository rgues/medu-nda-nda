...
@Component({
  selector: 'app-list-event-report',
  templateUrl: './list-event-report.component.html',
  styleUrls: ['./list-event-report.component.scss']
})
export class ListEventReportComponent implements OnInit {
  ...
  addReport() {
   ...
   updateReport(report) {
     ...
     this.router.navigate(['/report/update-report']);
   }
  ...
  getReports() {
    ...
    this.report.getAllReports(this.token).subscribe(reponse => {
